...
fn main() {
    let obj = _204 {
        st: ST {
            _01: element::E143::from_x12("204"),
            _02: "18711".to_string(),
        },
        b2: B2 {
            _02: Some("SNDR".to_string()),
            _04: Some(element::E373::from_x12("6XULT02DCM")),
            _06: element::E284::from_x12("DE"),
            ..Default::default()
        },
        b2a: B2A {
            _01: "00".to_string(),
        ...
        g62: Some(G62 {
            ...
            _02: Some(element::E373::from_x12("20221121")),
            _03: None,
            _04: Some(element::E337::from_x12("1513")),
            _05: Some(element::E623::from_x12("LT")),
        }),
        at5: Some(AT5 {
        ...
        loop_300: vec![
            _204Loop300 {
                ...
                loop_320: vec![_204Loop320 {
                    l5: Some(L5 {
                        _01: Some(element::E213::from_x12("1")),
