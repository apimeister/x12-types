...
crate::code_enum!(
    /// **436** Primary Publication Authority Code
    ///
    /// - Data element: 436
    /// - Type: Identifier (ID)
    /// - Length: min 2, max 2
    ///
    /// Primary Publication Authority Code. Code values verified against the Stedi X12 reference.
    E436 {
        /// Backward Reference
        "BR" => Br,
        /// Division Reference
...
crate::code_enum!(
    /// **461** Transit Level Code
    ///
    /// - Data element: 461
    /// - Type: Identifier (ID)
    /// - Length: min 1, max 3
    ///
    /// Transit Level Code. Code values verified against the Stedi X12 reference.
    E461 {
        /// First Prior Inbound
        "X" => X,
        /// Second Prior Inbound
        "XX" => Xx,
        /// Third Prior Inbound
        "XXX" => Xxx,
    }
