...
crate::code_enum!(
    ...
    /// - Length: min 2, max 2
    ///
    /// Entity Relationship Code. Code values verified against the Stedi X12 reference.
    E706 {
        /// Parent
        "01" => N01,
        /// Child
        ...
        /// Owner
        "38" => N38,
        /// Related for U.S. Customs Purposes
        "39" => N39,
        ...
        /// Contract
        "AF" => Af,
        /// Health Care Facility Affiliation
        "AG" => Ag,
        /// Independent Physician/Practice Association (IPA) Affiliation
        "AH" => Ah,
        /// Referral Lab Provider
        "AI" => Ai,
        /// Managed Care Organization Affiliation
        "AJ" => Aj,
        /// Medical Director
        "AK" => Ak,
        /// Health Care Network Affiliation
        "AL" => Al,
        /// Office Manager
        "AM" => Am,
        /// On-call Physician
        "AN" => An,
        /// Physician Hospital Organization (PHO) Affiliation
        "AO" => Ao,
...
crate::code_enum!(
    ...
    /// - Length: min 1, max 1
    ///
    /// Functional Group Acknowledge Code. Code values verified against the Stedi X12 reference.
    E715 {
        /// Accepted
        "A" => A,
...
crate::code_enum!(
    ...
    /// - Length: min 1, max 3
    ///
    /// Functional Group Syntax Error Code. Code values verified against the Stedi X12 reference.
    E716 {
...
crate::code_enum!(
    /// **745** Pre-Cooled (Rule 710) Code
    ///
    /// - Data element: 745
    /// - Type: Identifier (ID)
    /// - Length: min 1, max 1
    ///
    /// Pre-Cooled (Rule 710) Code. Code values verified against the Stedi X12 reference.
    E745 {
        /// Yes
        "Y" => Y,
    }
...
crate::code_enum!(
    ...
    /// - Length: min 2, max 2
    ///
    /// Surface/Layer/Position Code. Code values verified against the Stedi X12 reference.
    E752 {
        /// Side One
        "1S" => N1S,
        /// Side Two
        ...
        "RC" => Rc,
        /// Relative Position 14
        "RD" => Rd,
        /// Relative Position 15
        "RE" => Re,
        /// Relative Position 16
        "RF" => Rf,
        /// Relative Position 17
        "RG" => Rg,
        ...
        "RQ" => Rq,
        /// Relative Position 28
        "RR" => Rr,
        /// Relative Position 29
        "RS" => Rs,
        /// Relative Position 30
        "RT" => Rt,
        /// Relative Position 31
        "RU" => Ru,
        /// Relative Position 32
        "RV" => Rv,
        /// Relative Position 33
        "RW" => Rw,
        /// Relative Position 34
        "RX" => Rx,
        /// Relative Position 35
        "RY" => Ry,
        ...
        "S7" => S7,
        /// Relative Position 44
        "S8" => S8,
        /// Relative Position 45
        "S9" => S9,
        /// Relative Position 46
        "SA" => Sa,
        /// Right
        "SB" => Sb,
